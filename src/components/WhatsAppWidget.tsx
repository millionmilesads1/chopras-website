...
export default function WhatsAppWidget() {
  ...
  const phoneForWhatsApp = RESTAURANT.contact.phone.replace(/[+\s]/g, '')
  const message = 'Hello Chopras Indian Restaurant, I would like to make a reservation.'
  ...
  return (
    <>
      ...
      <div className="whatsapp-widget whatsapp-pulse">
        <a
          href={whatsappUrl}
          target="_blank"
          rel="nofollow noopener noreferrer"
          className="whatsapp-button"
          aria-label="Chat with Chopras on WhatsApp"
        >
