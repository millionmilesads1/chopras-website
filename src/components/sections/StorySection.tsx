    ...
    <section className="bg-[#FFFAF5] py-28 md:py-36 px-5 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <div className="absolute -left-3 top-8 rounded-full bg-[#D4AF37]/10 px-4 py-2 ring-1 ring-[#D4AF37]/25 backdrop-blur-sm">
        ...
        >
          ...
          <h2 className="font-heading font-semibold text-[#1B2B5E] text-4xl md:text-5xl lg:text-[3.25rem] leading-[1.07]">
            {tr.home.storyH2}
          </h2>
