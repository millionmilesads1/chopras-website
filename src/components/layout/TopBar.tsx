  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
        ...
        <p className="hidden md:block text-white/60 text-xs text-center">
        ...
        <div className="hidden md:flex items-center gap-4">
          <p className="text-white/60 text-xs">Free parking at Leyweg</p>
          <div className="w-px h-3 bg-white/20" />
          <p className="text-white/60 text-xs">100% Halal Certified</p>
        </div>
