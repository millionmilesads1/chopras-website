...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptions = {
    en: 'Authentic Indian wedding catering in Den Haag. Custom menus for your celebration. Fresh food, professional service.',
    nl: 'Authentieke Indiaas bruiloft catering in Den Haag. Op maat gemaakte menu voor je feest. Vers eten, professionele service.',
  }
  return {
    title: titles[locale],
    description: descriptions[locale],
    alternates: {
      canonical: `${SITE_URL}/${locale}/bruiloft-catering-den-haag`,
      languages: { en: `${SITE_URL}/en/bruiloft-catering-den-haag`, nl: `${SITE_URL}/nl/bruiloft-catering-den-haag`, 'x-default': `${SITE_URL}/en/bruiloft-catering-den-haag` },
    },
  }
}
...
export default function BruiloftCateringPage({ params }: Props) {
  ...
  return (
    <>
      <JsonLd data={getLocalRestaurantSchema(locale, ['Den Haag'], `${SITE_URL}/${locale}/bruiloft-catering-den-haag`)} />
      <JsonLd data={getBreadcrumbSchema([
        { name: tr.common.nav.home, item: `${SITE_URL}/${locale}` },
        { name: isNl ? 'Bruiloft Catering' : 'Wedding Catering', item: `${SITE_URL}/${locale}/bruiloft-catering-den-haag` },
      ])} />
