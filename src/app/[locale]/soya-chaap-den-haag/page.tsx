          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A] space-y-5">
            {isNl ? (
              ...
              <>
                ...
                <p>The soya chaap we use comes from suppliers who hold the same standards we do. No GMO, no unnecessary additives, no chemical names you cannot pronounce. Just sterilised soybeans processed into a nourishing form. It is halal. It is vegan. It is plant-based. And it costs around sixteen euro fifty - cheaper than many lamb curries on our menu.</p>
                <p>Vegan Indian food has received much attention in Den Haag in recent years. That is not chance. Authentic food that feels like food, not like a substitute, draws people in. Soya chaap Den Haag shows that you do not have to compromise on taste, texture or authenticity. You only have to choose plant-based.</p>
              </>
            )}
          </div>
        </div>
      ...
      <section className="bg-[#FFFAF5] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#1A1A1A] text-lg leading-relaxed mb-6">
            {isNl
              ? 'Soya chaap is slechts een optie in ons scala van plantaardig Indiaas voedsel. Ons volledige menu bevat ook dal makhani, chana masala, palak paneer, aloo gobi, en groente biryani. Elk gerecht wordt volledig bereid met dezelfde zorg als onze vleesgerechten. Geen compromissen. Geen aparte voorbereiding. Hetzelfde niveau van authenticiteit. Dit is vegetarisch eten dat je niet voelt als minder dan de vlees variant. Dit is eten dat je kiest omdat het goed is, niet omdat je geen vlees eet.'
