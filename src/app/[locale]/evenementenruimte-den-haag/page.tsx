      ...
      <section className="bg-[#FFFAF5] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-heading text-3xl md:text-4xl text-[#1B2B5E] mb-10">
            {isNl ? 'Populaire Event Gerechten' : 'Popular Event Dishes'}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link href={`${base}/butter-chicken-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#D4AF37] hover:shadow-lg transition-all">
              ...
              <p className="text-[#1B2B5E] font-semibold">{isNl ? 'Klassieke keuze voor events' : 'Classic choice for events'}</p>
            </Link>
            ...
            <Link href={`${base}/dal-makhani-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#D4AF37] hover:shadow-lg transition-all">
              ...
              <p className="text-[#1B2B5E] font-semibold">{isNl ? 'Vegetarische favorieten' : 'Vegetarian favourites'}</p>
            </Link>
            <Link href={`${base}/biryani-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#D4AF37] hover:shadow-lg transition-all">
              ...
              <p className="text-[#1B2B5E] font-semibold">{isNl ? 'Geurige rijst gerecht' : 'Fragrant rice dish'}</p>
            </Link>
          </div>
          <div className="mt-8 text-center space-y-4">
            <p className="text-[#1A1A1A] text-base">
              <Link href={`${base}/`} className="text-[#D4AF37] hover:text-[#e8c84a] font-semibold">
                {isNl ? 'Chopras Indiaas Restaurant - evenementenruimte en catering in Den Haag' : 'Chopras Indian Restaurant - event venue and catering in Den Haag'}
              </Link>
            </p>
            <p className="text-[#1A1A1A] text-base">
              {isNl ? 'Bekijk het volledige menu of' : 'View the full menu or'} <Link href={`${base}/contact`} className="text-[#D4AF37] hover:text-[#e8c84a] font-semibold">{isNl ? 'vraag een offerte aan voor je event' : 'request a quote for your event at Chopras'}</Link>.
            </p>
          </div>
        </div>
      </section>
