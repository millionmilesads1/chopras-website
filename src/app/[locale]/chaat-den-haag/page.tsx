        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A] space-y-5">
            {isNl ? (
              ...
              <>
                <p>Chaat in Den Haag is not a single dish. It is a whole category of Indian street food. Papdi chaat. Aloo tikki. Pani puri. Dahi puri. These are all chaat. What they have in common is that they are all food you eat with your hands, food that has presence, food that wakes your tongue. Chaat is sour, sweet, spicy and spiced all at once. It is food that has a show to it. It is food you experience, not just eat.</p>
                <p>Mumbai street food revolves entirely around chaat. At every corner, at every station, at every temple, there is a chaat seller. They make the same things every day - papdi chaat, aloo tikki, pani puri - and millions of people eat it. It is cheap. It is nourishing. It is delicious. And it tastes the same whether you are in Mumbai or in Den Haag. Chopras brings this authentic chaat to your city.</p>
