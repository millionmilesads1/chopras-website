      ...
      <section className="bg-[#1B2B5E] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            ...
            <Link href={`${base}/menu`} className="inline-block border-2 border-white text-white px-8 py-4 rounded-full font-bold hover:bg-white hover:text-[#1B2B5E] transition-colors text-center">
              {tr.common.viewMenu}
            </Link>
          </div>
        </div>
