...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptions = {
    en: 'We are hiring in Den Haag. Join the Chopras team as a chef, front-of-house server or event assistant. Be part of the fastest growing Indian restaurant in Den Haag.',
