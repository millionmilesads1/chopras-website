          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A] space-y-5">
            {isNl ? (
              ...
              <>
                ...
                <p>All meat  -  at every event, at every guest count, always  -  is sourced from halal-certified suppliers. This is not an upgrade or a premium add-on. It is simply how we work.</p>
              </>
            )}
          </div>
        </div>
