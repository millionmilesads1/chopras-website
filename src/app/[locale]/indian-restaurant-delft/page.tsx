...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const { locale } = params
  const titles = {
    en: 'Indian Restaurant Near Delft | Chopras in Den Haag',
    nl: 'Indiaas Restaurant bij Delft | Chopras in Den Haag',
  }
  const descriptions = {
...
export default function IndianRestaurantDelftPage({ params }: Props) {
  ...
  const restaurantSchema = {
    ...
    url: `${SITE_URL}/${locale}/indian-restaurant-delft`,
    ...
    areaServed: ['Delft', 'Den Haag', 'South Holland'],
  }
