          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A] space-y-5">
            {isNl ? (
              <>
                ...
                <p>De basmatirijst wordt geweekt en gedeeltelijk gekookt, bewust te kort gehouden, omdat hij de rest gaar trekt in de afgesloten pot. Echte saffraandraadjes worden in warm water geweekt en over de bovenste rijstlaag gedruppeld voordat de pot wordt afgesloten. Het deksel gaat op het vuur. De stoom doet de rest. Chopras Indian Restaurant serveert kipbiryani, lambiryani en groentebiryani. Alle drie zijn beschikbaar als onderdeel van het <Link href={`${base}/menu`} className="text-[#D4AF37] hover:underline">volledige Noord-Indiase menu</Link>, beoordeeld met 4,9 sterren op Google op basis van meer dan 800 recensies.</p>
      ...
      <section className="bg-[#1B2B5E] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-white/90 text-lg leading-relaxed">
            {isNl ? (
              <p>Authentieke biryani Den Haag vindt u bij Chopras Indian Restaurant, Leyweg 986, 2545 GW Den Haag, open van dinsdag tot en met zondag van 16:30 tot 22:30. Chopras Indian Restaurant serveert kip-, lam- en groentebiryani via de echte dum-methode: afgesloten, langzaam gegaard met echte saffraandraadjes en kruiden die elke ochtend vers worden gemalen van hele ingredienten uit India. Beoordeeld met 4,9 sterren op Google op basis van meer dan 800 recensies. Volledig <Link href={`${base}/halal-food-den-haag`} className="text-[#C7A348] hover:underline font-semibold">halal gecertificeerd</Link>. <Link href={`${base}/contact`} className="text-[#C7A348] hover:underline font-semibold">Reserveer een tafel</Link> of bestel online via Thuisbezorgd.</p>
            ) : (
